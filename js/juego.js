...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_horizontal.png', 140, 130, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 170, 130, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 500, 415, 30, 30, 1),
    //* vallas verticales
    new Obstaculo('imagenes/valla_vertical.png', 170, 470, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 475, 480, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 475, 450, 30, 30, 1),
    //* baches
    new Obstaculo('imagenes/bache.png', 185, 300, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 320, 380, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 290, 90, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 520, 130, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 820, 260, 30, 30, 1),
    //* autos
    new Obstaculo('imagenes/auto_verde_abajo.png', 185, 240, 15, 30, 1),
    new Obstaculo('imagenes/auto_verde_derecha.png', 250, 470, 30, 15, 1),
    new Obstaculo('imagenes/auto_verde_abajo.png', 790, 390, 15, 30, 1),
